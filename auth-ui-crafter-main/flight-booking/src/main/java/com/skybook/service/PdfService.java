...
public class PdfService {
    ...
    public byte[] generateTicketPdf(Booking booking) {
        try {
            if (booking.getFlight() == null) {
                throw new RuntimeException("Flight data is null for booking: " + booking.getId());
            }
            ...
            addTableRow(paymentTable, "Booking Date", 
                booking.getBookingDate() != null 
                    ? booking.getBookingDate().format(DateTimeFormatter.ofPattern("dd MMM yyyy, hh:mm a"))
                    : "N/A");
            addTableRow(paymentTable, "Total Amount", "₹" + String.format("%.2f", booking.getTotalAmount()));
    ...
    private void addTableRow(Table table, String label, String value) {
        ...
        table.addCell(new Cell().add(new Paragraph(value != null ? value : "N/A")).setPadding(8));
    }
}